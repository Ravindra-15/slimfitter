    ...
    <div className="min-h-screen bg-[#EFEDFA] flex flex-col">
      ...
      {showLimitModal && (
        ...
        >
          ...
          >
            <div className="w-14 h-14 rounded-full bg-[#EFEDFA] flex items-center justify-center mx-auto mb-4">
              <Trophy size={22} className="text-[#4E4391]" />
            </div>
            ...
            <button
              onClick={() => setShowLimitModal(false)}
              className="w-full px-6 py-3 bg-[#4E4391] hover:bg-[#4E4391] text-white text-sm font-semibold rounded-full shadow-[0_4px_14px_rgba(78,67,145,0.3)] transition-colors"
            >
              Got it
            </button>
          </div>
