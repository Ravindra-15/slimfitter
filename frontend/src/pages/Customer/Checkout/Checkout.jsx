            ...
            <>
              ...
              {bodyProfileLoading ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 px-4 sm:px-5 py-4 rounded-2xl border border-gray-100 bg-white hover:border-[#4E4391] transition-colors"
                >
                ...
                <button
                  type="button"
                  onClick={() => navigate("/body-profile?from=checkout")}
                  className="w-full flex items-center justify-between gap-3 px-4 sm:px-5 py-4 rounded-2xl border border-[#CFCBE6] bg-[#F4F2FA] hover:bg-[#ECEAF6] transition-colors"
                >
                  <span className="flex items-center gap-2.5 text-left">
                    <HeartPulse
                      size={18}
                    ...
                    />
                    <span>
                      <span className="block text-sm font-bold text-[#4E4391]">
                        Complete Your Body Profile
                      </span>
                      <span className="block text-[11px] text-[#6B5FA9] mt-0.5">
