            ...
            <div className="flex justify-center gap-2 sm:gap-3 mb-6">
              {otp.map((digit, index) => (
                <input
                  ...
                  onPaste={handlePaste}
                  className="w-11 h-12 sm:w-12 sm:h-14 text-center border border-gray-300 rounded-lg text-xl font-semibold text-gray-800 focus:border-[#4E4391] focus:ring-1 focus:ring-[#4E4391] outline-none transition-colors"
                />
              ))}
            </div>
