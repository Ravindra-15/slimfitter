        ...
        <div className="bg-white rounded-2xl border border-[#E3DFF0] shadow-[0_1px_3px_rgba(16,24,40,0.04)] p-6 sm:p-8">
          <div className="flex items-center justify-between mb-5">
            <h3 className="text-base font-bold text-gray-800">
              ...
              {unreadCount > 0 && (
                <span className="ml-2 inline-flex items-center justify-center bg-[#4E4391] text-white text-xs font-semibold rounded-full px-2 py-0.5">
                  {unreadCount}
                </span>
              )}
            </h3>
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-medium text-[#4E4391] hover:text- [#4E4391] transition-colors"
              >
                <CheckCheck size={14} />
                Mark all as read
              </button>
