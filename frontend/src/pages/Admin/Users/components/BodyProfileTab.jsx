/**
 * ADMIN MODULE — 27-Point Body Profile Tab
 *
 * Renders 5 grouped sections of health data: Metabolic, Physical,
 * Lifestyle, Symptoms, Family History. Empty state if no data yet.
 */
...
// 🧬 MAIN COMPONENT
// ============================================
const BodyProfileTab = ({ bodyProfile }) => {
    ...
    >
      ...
      <Section kind="physical" title="Physical Measurements">
        ...
        <Field
          ...
          value={
            physical?.bloodPressureSystolic
              ? `${physical.bloodPressureSystolic} mmHg`
              : null
          }
        />
        <Field
          ...
          value={
            physical?.bloodPressureDiastolic
              ? `${physical.bloodPressureDiastolic} mmHg`
              : null
          }
        />
        <Field
